...
public class Token extends Model {
     ...
     */
    private static Token getNewToken(Users user, TypeToken type, String email) {
     ...
     */
    public static void sendMailResetPassword(Users user) throws MalformedURLException {
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    public static void sendMailChangeMail(Users user, @Nullable String email) throws MalformedURLException {
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    private static void sendMail(Users user, TypeToken type, String email) throws MalformedURLException {
        Logger.debug("tokenfdggfdgdf: token = " +user );
