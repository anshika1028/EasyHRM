...
public class Signup extends Controller {
    ...
    public static Result save() {
        ...
        try {
            ...
            Logger.debug("inside time$$$$$$$$$$$$$$$$$$$$!!!!!!!!!!!!!!!!===" + new Date());
     ...
     */
    private static Result checkBeforeSave(Form<Application.Register> registerForm, String email, String username) {
        // Check unique email
        ...
        if (Users.findByUserName(username) != null) {
            flash("error", Messages.get("error.username.already.exist"));
            return badRequest(create.render(registerForm));
        }
     ...
     */
    private static void sendMailAskForConfirmation(Users user) throws EmailException, MalformedURLException {
     ...
     * @throws EmailException Exception when sending mail
     */
    private static void sendMailConfirmation(Users user) throws EmailException {
